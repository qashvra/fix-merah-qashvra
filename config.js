...
const TELEGRAM_BOT_TOKEN = '8838886404:AAGWNA8wyf4rA_l3mqZN7lcM6HZ2WNYp924'; 
const OWNER_ID = 8396965752;
const USERNAME_OWNER = '@qashvra'; 

// 2. Syarat Join (Channel & Group)
const VERIFICATION_GROUP_USERNAME = '@ChannelTelegram_Axxyl'; 
const VERIFICATION_CHANNEL_USERNAME = '@gchanokosfree'; 
...
// 5. Nama File Media 
const START_IMAGE_FILE = 'yazxx.jpg';
const START_AUDIO_FILE = 'corleone.mp3';
const SECONDARY_IMAGE_FILE = 'yazxx?.jpg'; 
